...
# Applying universal Justice by iterating over all defined routes.
for r in routes:
...
\section{Evidence}
Validation of the functional and ethical goals was achieved by executing the \texttt{cityswift\_z3\_implementation.py} script (v2.1). The solver leverages First-Order Logic (FOL) predicates and soft-constraint optimization to reconcile all 8 ethical cases. The successful ethical audit is shown in the terminal output below.

\begin{lstlisting}[style=mystyle, caption={Terminal Output of CitySwift Ethical Logic Engine (v2.1)}]
Executing CitySwift Ethical Logic Engine (v2.1 - FOL Integration)...

--- ETHICAL AUDIT: SATISFIED ---
...
Weather Care Active: True
Audit Result: NO PUNISHMENT (Confidence 0.92)
GDPR Status: ANONYMIZED MODE

Ethical Reconciliation: COMPLETE (8/8 cases formalised)
\end{lstlisting}
