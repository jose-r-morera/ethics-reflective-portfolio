...
\begin{figure}[h!]
  ...
  \caption{High-fidelity terminal output of the CitySwift Ethical Logic Engine, showing successful reconciliation of Deontological, Utilitarian, and Distributive constraints.}
  \label{fig:z3_output}
\end{figure}
