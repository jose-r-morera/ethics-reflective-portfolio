...
\begin{itemize}
    \item \textbf{Baseline Frequency}: The standard service level (buses per hour) mandated by the public transport contract. This serves as the reference point for assessing service drops and distributive justice.
    \item \textbf{Passenger Demand}: The predicted volume of commuters for a route. The system uses this value to prioritize high-capacity corridors in pursuit of utilitarian efficiency.
    \item \textbf{Route Criticality}: A binary flag identifying routes that serve essential infrastructure (e.g., hospitals, schools). Critical routes trigger stringent deontological safety rules.
\end{itemize}
...
---------------------------------------------------------------
Route 0       | 2           buses/hr | 100            pax |  [CRITICAL]
Route 1       | 0           buses/hr | 80             pax | 
Route 2       | 2           buses/hr | 120            pax |  [CRITICAL]
Route 3       | 0           buses/hr | 200            pax | 
Route 4       | 0           buses/hr | 50             pax | 
Route 5       | 0           buses/hr | 30             pax | 
Route 6       | 56          buses/hr | 300            pax | 
Route 7       | 0           buses/hr | 20             pax | 
Route 8       | 0           buses/hr | 150            pax | 
...
The solver output demonstrates a successful reconciliation between deontological safety rules and utilitarian efficiency. With a total fleet limit of 60 buses, the engine first satisfies the \textit{Deontological} mandates: Route 0 and Route 2 (Hospital/Critical) are allocated 2 buses each to meet the 50\% minimum service baseline (Case 1). The remaining 56 buses are then allocated to Route 6 (the highest demand corridor at 300 passengers), maximizing the system-wide \textit{Utilitarian} utility (Case 5). This result proves that the formal logic gate effectively protects vulnerable service areas while allowing the AI to optimize the remaining capacity for the common good.
