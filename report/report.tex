...
\begin{itemize}
  ...
  \item \textbf{E5: Driver Safety}: Enforcing legally mandated workload caps (8 hours per driver).
...
\begin{lstlisting}[style=py]
# E1: Critical Route Floor (50%)
for r in routes:
    optimizer.add(z3.Implies(is_critical(r), 
                            frequency(r) >= baseline_f(r) / 2))
\end{lstlisting}
...
\subsection{Goal E5: Driver Safety (Legality)}
\begin{lstlisting}[style=py]
