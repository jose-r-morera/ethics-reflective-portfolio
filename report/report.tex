...
\begin{itemize}
  ...
  \item \textbf{Accessibility and Service-Reliability Analysis:} To identify specific network vulnerabilities where service gaps or chronic unreliability disproportionately affect certain routes. This functional objective provides the data-led foundation for the "Transit Desert" ethical constraint implemented in Chapter 3.
\end{itemize}
...
\subsection*{1. Utilitarianism: Network Optimization and Distributive Justice}
...
\subsection*{2. Deontology: Algorithmic Sovereignty and Contractual Fairness}
...
\subsection*{3. Virtue Ethics: Ecological Character vs. The Ethics of Care}
...
To demonstrate the technical feasibility of these considerations, Chapter 3 formalizes these three schools into six distinct Z3-based constraints:
\begin{itemize}
  \item \textbf{Utilitarianism:} Implemented via \textit{Case 1 (Minimum Service)} and \textit{Case 5 (Carbon-Optimization)}.
  \item \textbf{Deontology:} Implemented via \textit{Case 2 (Penalty Confidence)} and \textit{Case 6 (Driver Fatigue)}.
  \item \textbf{Virtue Ethics:} Implemented via \textit{Case 3 (Weather Adaptation)} and \textit{Case 4 (Transit Desert Prevention)}.
\end{itemize}
%%%%%%%%
...
\section{Formal Ethical Constraints (6 Cases)}
...
\subsection{Case 4: Transit Desert Prevention (Relational Ethics / Virtue Ethics)}
Ensuring equitable access across all urban zones. Every zone must retain at least 60\% of its total baseline service capacity during any optimization step, embodying the virtue of communal care.
\begin{lstlisting}[style=py]
