...
\begin{itemize}
  \item \textbf{Routes ($R$)}: The fundamental units of service (e.g., Bus Éireann line segments).
...
\begin{itemize}
  \item \textbf{E1: Minimum Service Floor}: Deontological protection ensuring critical routes retain at least 50\% of baseline frequency.
  ...
  \item \textbf{E3: Operator Fairness}: Enforcing a 95\% confidence threshold for automated delay penalties.
  \item \textbf{E4: Virtue of Care}: Prioritizing human comfort (heating/boarding) over carbon efficiency in severe weather (sub-zero).
\end{itemize}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.95\textwidth]{functional_ethical_validation.png}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.95\textwidth]{goal_failure_validation.png}
