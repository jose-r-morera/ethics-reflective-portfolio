...
\begin{itemize}
    \item \textbf{Contractual Baseline}: The ideal service level (buses per hour) mandated by the franchise agreement. In this model, the baseline represents the "100\% target" from which ethical deviations are measured.
...
SUCCESSFUL. Ethical constraints are satisfied.

Route ID   | Allocated Frequency  | Passenger Demand   | Status
---------------------------------------------------------------
Route 0       | 6           buses/hr | 100            pax |  [CRITICAL]
Route 1       | 0           buses/hr | 80             pax | 
Route 2       | 2           buses/hr | 120            pax |  [CRITICAL]
Route 3       | 6           buses/hr | 200            pax | 
Route 4       | 6           buses/hr | 50             pax | 
Route 5       | 0           buses/hr | 30             pax | 
Route 6       | 34          buses/hr | 300            pax | 
Route 7       | 0           buses/hr | 20             pax | 
Route 8       | 6           buses/hr | 150            pax | 
Route 9       | 0           buses/hr | 10             pax | 
...
The solver output demonstrates a successful reconciliation between deontological safety rules and distributive justice. With a total fleet limit of 60 buses, the engine first satisfies the \textit{Deontological} mandates: Route 0 and Route 2 (Hospital/Critical) are protected. Crucially, the engine also enforces the \textbf{Ethical Minimum} (Case 4), ensuring that Zone 0 receives a total of 6 buses/hr (60\% of its 10-bus baseline) and other zones receive proportional minimums. The remaining capacity (34 buses/hr) is then allocated to Route 6 (the highest demand corridor), maximizing system-wide \textit{Utilitarian} utility (Case 5). This result proves that the formal logic gate effectively protects vulnerable communities while allowing for resource optimization.
